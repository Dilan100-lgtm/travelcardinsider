...
const reviewData = {
  ...
  // Source URLs
  urls: {
      officialPage: 'https://www.capitalone.com/small-business/credit-cards/spark-miles/',
      rewards: 'https://www.capitalone.com/credit-cards/rewards/',
      businessTools: 'https://www.capitalone.com/small-business/credit-cards/benefits/',
      visaBenefits: 'https://usa.visa.com/support/consumer/card-benefits.html',
      sparkSelect: 'https://www.capitalone.com/small-business/credit-cards/spark-miles-select/',
      chaseInk: 'https://creditcards.chase.com/business-credit-cards/ink/unlimited',
      amexBlue: 'https://www.americanexpress.com/us/credit-cards/business/business-credit-cards/american-express-blue-business-plus-credit-card/',
      bofaAdvantage: 'https://www.bankofamerica.com/smallbusiness/credit-cards/products/travel-rewards-business-credit-card/',
  },
...
const faqsContent = [
    { q: 'Do my Spark Miles expire?', a: `No, your miles will never expire as long as your account is open and in good standing. <a href="${reviewData.urls.rewards}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Source)</a>` },
    ...
    { q: 'What is the annual fee?', a: `The annual fee is $0 for the first year, then $95. <a href="${reviewData.ratesFeesLink}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(See Rates & Fees)</a>` }
];
...
function CapitalOneSparkMilesReviewPage() {
  ...
  const summaryBoxData = {
    welcomeOffer: `Earn <a href="${reviewData.applyLink}" target="_blank" rel="noopener noreferrer sponsored">50,000 bonus miles</a> after spending $4,500 in the first 3 months.`,
    annualFee: `<a href="${reviewData.ratesFeesLink}" target="_blank" rel="noopener noreferrer sponsored">$${reviewData.annualFee}</a> ($${reviewData.annualFeeIntro} First Year).`,
    topEarning: `Unlimited 2X miles on every purchase, plus <a href="${reviewData.urls.officialPage}" target="_blank" rel="noopener noreferrer sponsored">5X miles on hotels/rental cars</a> via Capital One Travel.`,
    keyPerks: `<a href="${reviewData.urls.officialPage}" target="_blank" rel="noopener noreferrer sponsored">Up to $100 Global Entry/TSA PreCheck® credit</a>, no foreign transaction fees, and <a href="${reviewData.urls.businessTools}" target="_blank" rel="noopener noreferrer sponsored">free employee cards</a>.`,
  ...
  const keyFeaturesTableData = [
    { feature: "Annual Fee", details: `<a href="${reviewData.ratesFeesLink}" target="_blank" rel="noopener noreferrer sponsored">$0 intro for the first year, then $95</a>` },
    { feature: "Welcome Bonus", details: `<a href="${reviewData.applyLink}" target="_blank" rel="noopener noreferrer sponsored">50,000 bonus miles</a> after a $4,500 spend in the first 3 months` },
    { feature: "Rewards Rate", details: "Unlimited 2X miles on every purchase, for every dollar your business spends" },
    { feature: "Bonus Rewards", details: `<a href="${reviewData.urls.officialPage}" target="_blank" rel="noopener noreferrer sponsored">Unlimited 5X miles</a> on hotels and rental cars booked through Capital One Travel` },
    { feature: "Key Travel Perk", details: `Up to a <a href="${reviewData.urls.officialPage}" target="_blank" rel="noopener noreferrer sponsored">$100 statement credit</a> for Global Entry or TSA PreCheck®` },
    { feature: "Foreign Fees", details: `<a href="${reviewData.ratesFeesLink}" target="_blank" rel="noopener noreferrer sponsored">None</a>` },
    { feature: "Credit Needed", details: "Good to Excellent" },
  ];

  const sectionContent = {
    'section-intro': `
      <p>In today's fast-paced business world, travel isn't a luxury—it's the engine of growth. But with rising costs, turning necessary expenses into valuable rewards isn't just a clever trick; it's an essential business strategy. The <strong>${reviewData.cardName}</strong> steps into this arena with a refreshingly simple promise: earn powerful travel rewards on every single dollar your business spends, without complex rules. <a href="${reviewData.urls.officialPage}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Details)</a></p>
    ...
    'section-welcome-bonus': `
      <p>The Spark Miles card rolls out the welcome mat with a solid sign-up bonus: earn <a href="${reviewData.applyLink}" target="_blank" rel="noopener noreferrer sponsored"><strong>50,000 bonus miles</strong> after you spend $4,500 on purchases within your first three months</a>.</p>
    ...
    `,
     'section-transfer-partners': `
      <p>For those who enjoy playing the points-and-miles game, transferring your Spark Miles to one of Capital One’s <strong>15+ airline and hotel partners</strong> is the key to unlocking outsized value. <a href="${reviewData.urls.rewards}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(See Partners)</a> This is how you turn everyday business spending into a lie-flat business-class seat or a luxury hotel stay.</p>
    ...
    'section-travel-perks': `
        ...
        <ul>
            <li><strong>Global Entry or TSA PreCheck® Credit:</strong> Receive a statement credit of up to $100 when you use your card to pay the application fee for either program. <a href="${reviewData.urls.officialPage}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Details)</a></li>
            <li><strong>No Foreign Transaction Fees:</strong> A must-have for international business, saving you ~3% on every purchase abroad. <a href="${reviewData.ratesFeesLink}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(See Fees)</a></li>
            <li><strong>Auto Rental Collision Damage Waiver:</strong> Provides coverage for theft or damage to your rental car when you pay with your card. <a href="${reviewData.urls.visaBenefits}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Visa Guide)</a></li>
            <li><strong>Extended Warranty Protection:</strong> Adds an extra year to the manufacturer’s warranty on eligible items you purchase. <a href="${reviewData.urls.visaBenefits}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Visa Guide)</a></li>
        </ul>
    `,
    'section-business-tools': `
        <p>The Spark Miles card is more than just a rewards tool; it’s a command center for your business spending. <a href="${reviewData.urls.businessTools}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Learn More)</a></p>
        <ul>
    ...
    `,
    'section-rates-fees': `
      <p>No one loves talking about fees, but it's crucial to know the numbers before you apply. The high APR means this is not a card for carrying a balance, as interest costs will quickly erase your rewards. You can view the full <a href="${reviewData.ratesFeesLink}" target="_blank" rel="noopener noreferrer sponsored">official rates and fees on Capital One's site</a>.</p>
      <ul>
        <li><strong>Annual Fee:</strong> $0 for the first year, then $95.</li>
        <li><strong>Purchase APR:</strong> A variable rate, currently ${reviewData.aprRange}.</li>
        <li><strong>Foreign Transaction Fee:</strong> None.</li>
        <li><strong>Late Payment Fee:</strong> Up to $39.</li>
      </ul>
    `,
    ...
    'section-competitors': `
      ...
      <p><strong>The Analysis:</strong> The Spark Miles card stands out for business owners who prioritize travel rewards and simplicity. While the <a href="${reviewData.urls.chaseInk}" target="_blank" rel="noopener noreferrer sponsored">Chase Ink Business Unlimited®</a> offers great cash back and the <a href="${reviewData.urls.amexBlue}" target="_blank" rel="noopener noreferrer sponsored">Amex Blue Business® Plus</a> has a strong 2X rate on a capped amount, neither provides the combination of a high, unlimited 2X miles rate plus premium travel perks like the Global Entry credit and no foreign transaction fees. This makes the Spark Miles card a uniquely powerful tool for businesses that operate and travel globally.</p>
    `,
    'section-pros-cons': `
      <p>Is this the right card for your business wallet?</p>
      <h3>Why Spark Miles Shines (Pros)</h3>
      <ul>
        <li><strong>Effortless High Rewards:</strong> The unlimited 2X miles on every single purchase is the star of the show.</li>
        <li><strong>Big Upfront Value:</strong> The 50,000-mile welcome bonus is worth $500 in travel, easily covering the annual fee for years.</li>
        <li><strong>Flexible Redemptions:</strong> Erase any travel purchase or transfer miles to valuable airline partners.</li>
        <li><strong>Essential Travel Perks:</strong> The Global Entry / TSA PreCheck® Credit and no foreign transaction fees are tangible, money-saving benefits.</li>
        <li><strong>Free Employee Cards:</strong> Add cards for your team at no extra cost to accelerate rewards.</li>
      </ul>
      <h3>Potential Downsides (Cons)</h3>
      <ul>
        <li><strong>Has an Annual Fee:</strong> While waived the first year, the $95 fee applies thereafter.</li>
    ...
    'section-no-fee-alternative': `
        <p>If you're hesitant about the $95 annual fee, Capital One has a fantastic alternative: the <a href="${reviewData.urls.sparkSelect}" target="_blank" rel="noopener noreferrer sponsored"><strong>Spark Miles Select for Business</strong></a>. It has a $0 annual fee and still earns a respectable unlimited 1.5X miles on every purchase.</p>

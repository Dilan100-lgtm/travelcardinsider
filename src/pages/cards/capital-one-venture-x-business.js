...
const reviewData = {
  ...
  // This is a Pay-in-Full card, so there's no APR range. This is noted in the schema.
  ...
  // Source URLs from user's document
  urls: {
...
const structuredDataOptimized = {
  ...
  '@graph'  : [
    ...
    { '@type' : 'Organization',
      ...
      sameAs  : [ "https://www.facebook.com/YourTravelCardInsiderFacebookPage", "https://twitter.com/YourTravelCardInsiderTwitterHandle" ], // **ACTION**: Replace
    },
  ],
};
...
const tocSections = [
    ...
    { id: 'section-annual-fee', title: '8. The $395 Annual Fee: Cost or Investment?' },
    { id: 'section-premium-perks', title: '9. Premium Perks: Lounge Access & More' },
    ...
    { id: 'section-understated-perks', title: '13. Understated Perks You Shouldn’t Ignore' },
    { id: 'section-final-verdict', title: '14. Final Verdict: The TravelCardInsider Bottom Line' },
    { id: 'section-faqs-jump', title: '15. Frequently Asked Questions' },
];
...
function CapitalOneVentureXBusinessReviewPage() {
  ...
  // Handlers for tooltips (re-used for consistency)
  ...
  const sectionContent = {
    ...
    `,
    'section-philosophy': `
      <p>In a market crowded with complex rewards programs, the ${reviewData.cardName} stands out with a clear philosophy: blend the ease of a flat-rate earning structure with the tangible benefits of a premium travel card. The card’s foundational <strong>unlimited 2X miles on every purchase</strong> is refreshingly easy to track, yet it doesn’t skimp on the perks that genuinely improve the travel experience, like airport lounge access and valuable annual credits. <a href="${reviewData.urls.rewardsProgram}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Program Terms)</a></p>
      <p>This dual appeal is the cornerstone of its design. It’s engineered to make its $395 annual fee feel less like a cost and more like a prepaid investment in travel, as the benefits are designed to return at least <strong>$400 in value each year</strong>. This strategic positioning makes it a powerful contender for businesses that demand both performance and simplicity.</p>
    `,
    'section-welcome-bonus': `
      <p>A card’s welcome offer is its first handshake, and the Venture X Business makes a strong impression. The standard bonus is <a href="${reviewData.urls.offerDetails}" target="_blank" rel="noopener noreferrer sponsored"><strong>150,000 miles after you spend $30,000 on purchases</strong> within the first three months</a> of account opening. Capital One values these miles at a straightforward <strong>$1,500 when redeemed for travel</strong>, giving you a clear and immediate return on your initial spending.</p>
      <p>The $30,000 spending requirement is undeniably substantial and acts as a filter, positioning the card for businesses with significant and consistent cash flow. For companies that can comfortably meet this through regular operational costs—like inventory, ad campaigns, or software investments—the bonus is a massive head start.</p>
    `,
    'section-earning-engine': `
      <p>At the heart of the Venture X Business card is its refreshingly simple rewards engine: an <strong>unlimited 2X miles on every dollar you spend</strong>. There are no rotating categories to track for your everyday business purchases and no caps on how many miles you can earn. <a href="${reviewData.urls.rewardsProgram}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Rewards Page)</a></p>
      <h3>Elevating Your Travel: The 5X and 10X Bonus Categories</h3>
      <p>While the 2X base rate is a solid foundation, the card truly accelerates your earnings when you book through the Capital One Travel portal. This is where your rewards strategy kicks into high gear:</p>
      <ul>
        <li><strong>10X miles</strong> on hotels and rental cars</li>
        <li><strong>5X miles</strong> on flights</li>
      </ul>
      <p>A 10X return on hotels is exceptionally competitive and can lead to a massive accumulation of miles from your business travel. To make the portal more attractive, Capital One includes features like price-drop protection and a price-match guarantee. <a href="${reviewData.urls.travelPortalBenefits}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Portal Benefits)</a></p>
    `,
    'section-redeeming-value': `
      <p>Earning miles is only half the fun; redeeming them is where the value comes home. The Venture X Business offers flexible options to suit your preferences.</p>
        <ul>
            <li><strong>Cover Travel Purchases:</strong> This is the simplest method. Book travel anywhere and use your miles to "erase" the purchase from your statement within 90 days at a value of 1 cent per mile. <a href="${reviewData.urls.rewardsRedemption}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Redemption Options)</a></li>
            <li><strong>Book via Capital One Travel:</strong> Use your miles directly in the portal to book flights, hotels, and rental cars, also at a rate of 1 cent per mile.</li>
            <li><strong>Transfer to Partners:</strong> This is where you can find incredible value by transferring miles to Capital One’s 15+ airline and hotel partners.</li>
            <li><strong>Other Options:</strong> You can also redeem for cash back or gift cards, but the value is typically lower than travel redemptions and is generally not recommended.</li>
        </ul>
    `,
     'section-transfer-partners': `
      <p>For those willing to do a little research, transferring Capital One miles to airline and hotel partners is the key to unlocking outsized value. Most of Capital One’s 15+ partners, which include Air Canada Aeroplan, British Airways, and Air France-KLM Flying Blue, feature a simple 1:1 transfer ratio. <a href="${reviewData.urls.transferPartners}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(See Partner List)</a></p>
      <p>Here’s a real-world example: A business-class ticket to Europe might cost $5,000 in cash or 500,000 miles through the portal. By transferring just <strong>120,000 miles</strong> to a partner like Air Canada Aeroplan, you could book that same flight on a Star Alliance partner like United or Lufthansa, more than quadrupling the value of your miles. This transforms your rewards from simple rebates into truly aspirational travel experiences.</p>
    `,
    'section-annual-fee': `
      <p>For the right business, the <strong>$395 annual fee</strong> on the Venture X Business card functions more like a prepaid travel investment than a sunken cost. The card’s value proposition hinges on two key benefits that, when used, provide a direct return of <strong>$400 each year</strong>.</p>
      <ul>
          <li><strong>$300 Annual Travel Credit:</strong> Received for bookings made through the Capital One Travel portal. For any business that spends at least this amount on travel annually, this credit is as good as cash.</li>
          <li><strong>10,000 Anniversary Bonus Miles:</strong> Starting on your first anniversary, you receive these bonus miles every year. Valued at a minimum of $100 toward travel, this bonus brings the total direct value to $400.</li>
      </ul>
      <p>This means that a business actively using the card for travel effectively has its annual fee covered. This "cost-neutral" framework is a powerful part of its appeal.</p>
    `,
    'section-premium-perks': `
        <p>A key premium perk, airport lounge access can turn a stressful travel day into a productive and relaxing one. The Venture X Business card offers a powerful two-pronged approach:</p>
        <ul>
            <li><strong>Capital One Lounges:</strong> Enjoy complimentary access for yourself and two guests to the growing network of Capital One Lounges, known for their premium food and modern design.</li>
            <li><strong>Priority Pass™ Select:</strong> This membership grants you and two guests access to over 1,300 airport lounges worldwide, ensuring you have an option in most major airports you visit. <a href="${reviewData.urls.loungeAccess}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Lounge Policy)</a></li>
        </ul>
    `,
    'section-user-profile': `
        <p>This card shines brightest for a specific type of business. The ideal cardholder is a high-spending entrepreneur or a small to medium-sized enterprise with consistent cash flow that can handle the <strong>pay-in-full requirement</strong>.</p>
        <p>They travel several times a year, ensuring they can easily use the $300 travel credit and benefit from lounge access. They value simplicity and appreciate earning a high, flat rate of 2X miles on all their diverse business expenses without having to track categories. This card is for the business that sees travel perks as a necessity, not just a luxury.</p>
    `,
    'section-real-world-example': `
      <p>Let's imagine "Innovate Solutions LLC," a marketing agency that spends $120,000 annually on its card. Their breakdown is:</p>
      <ul>
          <li>$20,000 on flights and hotels (booked via Capital One Travel)</li>
          <li>$100,000 on other expenses (ads, software, supplies)</li>
      </ul>
      <p><strong>Here’s their rewards haul in Year 1:</strong></p>
      <ul>
          <li><strong>Welcome Bonus:</strong> 150,000 miles</li>
          <li><strong>Rewards from Travel:</strong> ($10k flights x 5X) + ($10k hotels x 10X) = 150,000 miles</li>
          <li><strong>Rewards from Other Spend:</strong> $100,000 x 2X = 200,000 miles</li>
      </ul>
      <p><strong>Total First-Year Miles: 500,000 miles</strong>. The total value is immense: <strong>$5,000</strong> from miles + <strong>$300</strong> from the travel credit. After the $395 fee, the net value is a staggering <strong>$4,905</strong>.</p>
    `,
    'section-competitors': `
      <p>No card exists in a vacuum. Here’s how the Venture X Business stacks up against the titans of the industry.</p>
    `,
    'section-understated-perks': `
      <p>Beyond the big-ticket items, the Venture X Business offers a suite of valuable protections that you can explore in the official <a href="${reviewData.urls.benefitsGuide}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">Guide to Benefits</a>.</p>
      <ul>
        <li><strong>Cell Phone Protection:</strong> Pay your wireless bill with the card and get up to $800 in coverage per claim if your phone is stolen or damaged (deductible applies).</li>
        <li><strong>Primary Auto Rental Insurance:</strong> Can save you money and hassle when renting cars for business.</li>
        <li><strong>Extended Warranty Protection:</strong> Doubles the manufacturer's warranty for up to one additional year on eligible purchases.</li>
        <li><strong>Free Employee Cards:</strong> Add employees at no extra cost and earn rewards on all their business spending. <a href="${reviewData.urls.accountManagement}" target="_blank" rel="noopener noreferrer sponsored" class="${styles.inlineLink}">(Management Features)</a></li>
        <li><strong>No Foreign Transaction Fees:</strong> A must-have for international business.</li>
      </ul>
    `,
    'section-final-verdict': `
      <p>The <strong>${reviewData.cardName}</strong> is a formidable tool for the right kind of business. It masterfully blends straightforward, high-value rewards with the premium travel perks that truly matter, all while making its annual fee remarkably easy to justify. The simple foundation of unlimited 2X miles, supercharged by the 5X and 10X portal bonuses, creates a powerful rewards engine.</p>
      <p>This card is tailor-made for high-spending businesses with stable cash flow that can manage a pay-in-full card. It successfully carves out a unique space, offering premium benefits with an unbeatable effective cost. If your business values simplicity, powerful rewards, and tangible travel benefits, the Venture X Business isn’t just a good choice—it’s a brilliant one.</p>
    `,
    'section-faqs-jump': `
            ...
            <div className={styles.reviewContainer}>
              <article>
                ...
                {tocSections.map(section => {
                    ...
                    } else if (section.id === 'section-final-verdict' || section.id === 'section-faqs-jump') {
                        // These are rendered manually later in the correct order
                        return null;
                    }
                ...
                {/* --- Post-Verdict CTA Section --- */}
                <section className={`${styles.reviewSection} ${styles.postVerdictCtaSection}`}>
                    <h3>Ready to Elevate Your Business Travel?</h3>
                    <p>
                        If our expert verdict on the Capital One Venture X Business aligns with your need for simple, powerful travel rewards, it's time to take the next step.
                ...
                {/* --- FAQ Section (Rendered after Verdict as requested) --- */}

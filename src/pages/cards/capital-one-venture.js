  ...
  '@graph': [
    ...
    { '@type': 'BreadcrumbList',
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Credit Card Reviews', item: `${siteUrl}/review` },
...
const tocSections = [
    { id: 'section-intro', title: 'A Traveler\'s Dilemma' }, { id: 'section-snapshot', title: 'Card Snapshot' }, { id: 'section-best-for', title: '"Best For" Tagline' }, { id: 'section-earning-engine', title: 'The Earning Engine' }, { id: 'section-welcome-bonus', title: 'The Welcome Bonus' }, { id: 'section-redemption', title: 'Mastering Redemption' }, { id: 'section-transfer-partners', title: 'Guide to Transfer Partners' }, { id: 'section-global-entry', title: 'Global Entry Credit' }, { id: 'section-lounge-access', title: 'Annual Lounge Passes' }, { id: 'section-lifestyle-collection', title: 'The Lifestyle Collection' }, { id: 'section-protections', title: 'Travel Protections' }, { id: 'section-rates-fees', title: 'Rates & Fees' }, { id: 'section-is-it-worth-it', title: 'Is the Fee Worth It?' }, { id: 'section-user-profiles', title: 'Is This Card For You?' }, { id:- 'section-real-world-trip', title: 'Real-World Example' }, { id: 'section-pros-cons', title: 'Pros and Cons' }, { id: 'section-testimonials', title: 'User Testimonials' }, { id: 'section-comparison', title: 'Competitive Showdown' }, { id: 'section-faqs-jump', title: 'FAQs' }, { id: 'section-final-verdict', title: 'Final Verdict' }, { id: 'section-eat', title: 'Our E-A-T Commitment' }
];
...
const sectionContent = {
    ...
    'section-snapshot': `<p>Here’s a quick look at the core features of the ${reviewData.cardName}. Its blend of high rewards and practical benefits makes it a formidable tool for any traveler.</p>`,
    ...
    'section-rates-fees': `<p>Transparency in costs is critical. The annual fee is $95 and there are no foreign transaction fees. The regular purchase APR is variable. Always pay your balance in full to avoid interest charges. [<a href="${reviewData.urls.ratesDisclosures}" target="_blank" rel="noopener noreferrer sponsored">Source: Capital One</a>]</p>`,
    ...
    'section-comparison': `<p>The Venture card's value is best understood when compared against its rivals.</p>`,
...
const keyFeaturesTableData = [
    ...
    { feature: "Welcome Bonus", details: `75,000 bonus miles after a $4,000 spend in the first 3 months` },
    { feature: "Base Rewards Rate", details: "Unlimited 2X miles on every purchase" },
    { feature: "Bonus Rewards", details: `5X miles on hotels & rental cars booked through Capital One Travel` },
    { feature: "Key Credits", details: `Up to $100 for Global Entry / TSA PreCheck®` },
    { feature: "Lounge Access", details: `2 complimentary passes to Capital One or Plaza Premium Lounges annually` },
];
...
function CapitalOneVentureReviewPage() {
    ...
    // All handlers from the Venture X Business file are used here
                 ...
                 <div className={styles.reviewPageLayout}>
                    <div className={styles.mainContentArea}>
                        ...
                        <article>
                            ...
                            {tocSections.filter(s => !['section-snapshot', 'section-pros-cons', 'section-comparison', 'section-faqs-jump'].includes(s.id)).map(section => (
                            ...
                            <section id="section-comparison" className={styles.reviewSection}>
                                <h2 dangerouslySetInnerHTML={{ __html: tocSections.find(s => s.id === 'section-comparison').title }}></h2>
                                <div dangerouslySetInnerHTML={{ __html: sectionContent['section-comparison'] }} />
                            </section>

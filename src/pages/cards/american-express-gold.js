...
// --- Updated data object based on new content ---
const reviewData = {
...
    // Updated description for structured data
...
    "offers": {
      "@type": "Offer",
      // Kept original apply link
      "url": reviewData.applyLink.startsWith('http') ? reviewData.applyLink : `${siteUrl}${reviewData.applyLink}`, // *** Ensure full APPLY URL ***
      "priceCurrency": "USD",
      // *** NOTE: Fee is $325 in new text, but kept $250 here as links/ratings were not to change. VERIFY & UPDATE PRICE ***
      "price": "250", // Annual Fee - *** VERIFY/UPDATE BASED ON CURRENT OFFER & TEXT ***
...
                {/* RATING SECTION (KEEPING ORIGINAL) */}
...
                      {/* --- Conditionally Rendered Tooltip (KEEPING ORIGINAL LOGIC & CRITERIA) --- */}
                      {showRatingInfo && (
                            <div
                                ref={tooltipRef}
...
                  {/* Rating Description - Adjusted slightly for context, but kept original rating */}
...
            {/* ============= REVIEW CONTENT SECTIONS (Replaced with New Content) ============= */}

            {/* Section 2: Snapshot: Key Features and Current Welcome Offer */}
...
            {/* CTA Section (KEEPING ORIGINAL - Links/Text might need update based on $325 fee) */}
...
              </div>
            {/* *** Reminder: The 'price' in structured data and potentially the Rates & Fees link need updating for the $325 fee mentioned in the new text *** */}
            </section>

            {/* Section 3: Unpacking the $325 Annual Fee: Is It Justified for Travelers? */}
...
            {/* Section 4: Earning Power: Maximizing 4X Points on Global Dining */}
...
            {/* Section 5: Earning Power: Stocking Up with 4X Points at U.S. Supermarkets */}
...
            {/* Section 6: Travel Focus: Earning 3X Points on Flights (Direct & AmexTravel.com) */}
...
            {/* Section 7: Travel Focus: Earning 2X Points via AmexTravel.com (Hotels, Packages, etc.) */}
...
            {/* Section 8: The Foundation: Understanding Membership Rewards® Points Value */}
...
            {/* Section 9: Travel Focus: Redeeming Points: Mastering Airline & Hotel Transfers (Key Partners) */}
...
            {/* Section 10: Travel Focus: Redeeming Points: Booking Directly via Amex Travel */}
...
            {/* Section 11: $120 Dining Credit: Savoring Monthly Savings (Partners & Enrollment) */}
...
            {/* Section 12: Travel Focus: $120 Uber Cash: Credits for Rides & Eats On-the-Go (US Focus) */}
...
            {/* Section 13: $100 Resy Credit: Elevating Your U.S. Dining Experiences */}
...
           {/* Section 14: $84 Dunkin' Credit: Fueling Your Mornings (US Focus) */}
...
            {/* Section 15: Calculating the Value: How Credits Offset the Annual Fee */}
...
            {/* Section 16: Travel Focus: The Hotel Collection Benefits ($100 Credit & Upgrades) */}
...
            {/* Section 17: Travel Focus: Essential Travel Protections: Baggage & Car Rental Insurance (Secondary) */}
...
            {/* Section 18: Travel Focus: Added Peace of Mind: Global Assist® Hotline & No Foreign Transaction Fees */}
...
            {/* Section 19: Beyond Travel: Purchase Protection & Extended Warranty Deep Dive */}
...
           {/* Section 20: Final Verdict: Is the Amex Gold Your Ideal Travel Companion? (Conclusion & Recommendations) */}
...
                <strong>Disclaimer:</strong> Terms, interest rates, fees, welcome offers, credit partners, point values, and insurance benefits are subject to change at any time. Always verify current details directly with American Express before applying. Affiliate links may be present; editorial opinions are independent. Points valuations are estimates and vary based on redemption. Carrying a balance will incur interest charges that can outweigh rewards. Refer to official American Express documentation for the most up-to-date Terms & Conditions.
             {/* Updated Disclaimer slightly */}
              </p>
            </section>

            {/* E-A-T Section (KEEPING ORIGINAL CONTENT as new text wasn't provided) */}
             <section id="eat-expertise-authority-trustworthiness" className={`${styles.reviewSection} ${styles.eatSection}`}>
                <h2 dangerouslySetInnerHTML={{ __html: "Our Commitment to E-A-T: Expertise, Authority &amp; Trustworthiness"}}></h2>
                <p>
                    At <strong>TravelCardInsider</strong>, we prioritize: {/* *** REPLACE with your site name *** */}
                </p>
                <h3>1. Expertise</h3>
                <ul className={styles.featureList}>
...
                    Our detailed coverage dives beyond basics,
...
                    We’re frequently cited in top finance/travel outlets for unbiased Amex coverage. {/* *** Customize this claim *** */}
...
                    If major changes occur (e.g., new fee structures, credit changes),
...
                        as explained in our <Link href="/privacy-policy"><a>Privacy Policy</a></Link>. {/* *** Ensure this link works *** */}
                    </li>
                </ul>
                <p>
                    By following E-A-T, we aim to deliver a thorough, trustworthy evaluation
                    of the <strong>{reviewData.cardName}</strong>,
                    so you can decide if it’s your ideal travel and dining companion.
                </p>
            </section>

// File: pages/reviews/BestStarterTravelCardsPage2025.js – FINAL COMPLETE VERSION
// ❗ Replace image src paths (in starterCardData and constants) with your optimised, WebP‑or‑AVIF images.
// The paths below are placeholders.
// ✏️ Update applyLink and ratesFeesLink for each card with actual sponsored URLs.
// ✏️ Update learnMoreLink for each card to point to your full review pages.
// ✏️ Update card ratings (ratingValue, ratingStars) as needed.
...
// 🔗 CONFIG
// ─────────────────────────────────────────────────────────────────────────────
const SITE_BASE_URL = 'https://www.travelcardinsider.com'; // ✏️ Replace if different
...
const HERO_IMAGE_SRC = '/images/starter-cards-hero.webp'; // ✏️ Replace with your optimised hero image
...
const DATE_MODIFIED = '2025-05-21'; // ✏️ Update whenever you edit copy
...
const author = {
  ...
  // fullBioLink: '/about/dilan-madushanka' // Example: Add this if you have a full bio page
};
...
const starterCardData = [
  {
    ...
    imageSrc: '/images/cards/chase_sapphire_preferred.webp', // ✏️ Placeholder
    imageAlt: 'Chase Sapphire Preferred Card',
    ratingValue: 8.8, // ✏️ Placeholder rating
    ratingStars: 4.5, // ✏️ Placeholder rating
    annualFee: '$95',
    ...
    ftf: 'None',
    applyLink: '#apply-csp', // ✏️ Replace with actual APPLY link
    ratesFeesLink: '#rates-fees-csp', // ✏️ Replace with actual RATES & FEES link
    learnMoreLink: '/cards/chase-sapphire-preferred-review', // ✏️ Replace with your review page path
  },
  {
    id: 'capitalOneVentureOne',
    name: 'Capital One VentureOne Rewards Credit Card',
    imageSrc: '/images/cards/capital_one_ventureone.webp', // ✏️ Placeholder
    imageAlt: 'Capital One VentureOne Rewards Credit Card',
    ratingValue: 8.0, // ✏️ Placeholder rating
    ratingStars: 4.0, // ✏️ Placeholder rating
    annualFee: '$0',
    ...
    rewards: 'Unlimited 1.25 miles per dollar on every purchase, every day. Earn 5 miles per dollar on hotels and rental cars booked through Capital One Travel.',
    ...
    headsUp: 'The base earning rate of 1.25x miles is lower than some other cards.',
    ftf: 'None',
    applyLink: '#apply-c1v1',
    ratesFeesLink: '#rates-fees-c1v1',
    learnMoreLink: '/cards/capital-one-ventureone-review',
  },
  {
    id: 'wellsFargoAutograph',
    name: 'Wells Fargo Autograph℠ Card',
    imageSrc: '/images/cards/wells_fargo_autograph.webp', // ✏️ Placeholder
    imageAlt: 'Wells Fargo Autograph Card',
    ratingValue: 8.2, // ✏️ Placeholder rating
    ratingStars: 4.0, // ✏️ Placeholder rating
    annualFee: '$0',
    ...
    ftf: 'None',
    applyLink: '#apply-wfa',
    ratesFeesLink: '#rates-fees-wfa',
    learnMoreLink: '/cards/wells-fargo-autograph-review',
  },
  {
    id: 'biltMastercard',
    name: 'Bilt Mastercard®',
    imageSrc: '/images/cards/bilt_mastercard.webp', // ✏️ Placeholder
    imageAlt: 'Bilt Mastercard',
    ratingValue: 8.5, // ✏️ Placeholder rating
    ratingStars: 4.5, // ✏️ Placeholder rating
    annualFee: '$0',
    ...
    ftf: 'None',
    applyLink: '#apply-bilt',
    ratesFeesLink: '#rates-fees-bilt',
    learnMoreLink: '/cards/bilt-mastercard-review',
  },
  {
    id: 'discoverItMiles',
    name: 'Discover it® Miles',
    imageSrc: '/images/cards/discover_it_miles.webp', // ✏️ Placeholder
    imageAlt: 'Discover it Miles card',
    ratingValue: 7.8, // ✏️ Placeholder rating
    ratingStars: 4.0, // ✏️ Placeholder rating
    annualFee: '$0',
    ...
    rewards: 'Unlimited 1.5x Miles on every dollar of every purchase.',
    whyGreat: 'The first-year Miles Match effectively means earning 3x miles on all purchases for the first year, which is fantastic. Simple earning and redemption. No foreign transaction fees.',
    headsUp: 'After the first year, the 1.5x earning rate is standard. It offers fewer travel-specific insurance perks compared to some other travel cards.',
    ftf: 'None',
    applyLink: '#apply-dim',
    ratesFeesLink: '#rates-fees-dim',
    learnMoreLink: '/cards/discover-it-miles-review',
  },
  {
    id: 'chaseFreedomUnlimited',
    name: 'Chase Freedom Unlimited®',
    imageSrc: '/images/cards/chase_freedom_unlimited.webp', // ✏️ Placeholder
    imageAlt: 'Chase Freedom Unlimited card',
    ratingValue: 8.3, // ✏️ Placeholder rating
    ratingStars: 4.0, // ✏️ Placeholder rating
    annualFee: '$0',
    ...
    // Original text had "$200 bonus after $500 spend in 3 months." This is a common CFU offer. The prompt's text described a first-year % bonus. I'll use the prompt's text and note to verify.
    ...
    ftf: '3%',
    applyLink: '#apply-cfu',
    ratesFeesLink: '#rates-fees-cfu',
    learnMoreLink: '/cards/chase-freedom-unlimited-review',
  },
  {
    id: 'bofaTravelRewards',
    name: 'Bank of America® Travel Rewards credit card',
    imageSrc: '/images/cards/bofa_travel_rewards.webp', // ✏️ Placeholder
    imageAlt: 'Bank of America Travel Rewards credit card',
    ratingValue: 7.9, // ✏️ Placeholder rating
    ratingStars: 4.0, // ✏️ Placeholder rating
    annualFee: '$0',
    ...
    rewards: 'Earn unlimited 1.5 points per $1 spent on all purchases. Points can be boosted by 25%-75% if you are a Bank of America Preferred Rewards® member (up to 2.62x points).',
    ...
    headsUp: 'The base 1.5x earning rate is standard; the card truly shines only with the Preferred Rewards boost.',
    ftf: 'None',
    applyLink: '#apply-bofa',
    ratesFeesLink: '#rates-fees-bofa',
    learnMoreLink: '/cards/bank-of-america-travel-rewards-review',
  }
];
...
const comparisonStarterCardData = [
  { name: 'Chase Sapphire Preferred®', fee: '$95', bonus: '60k pts ($5k/3mo)', perk: '5x travel (Chase), 3x dining, $50 hotel credit, 1:1 transfers', apr: '19.99%-28.24% Var.', ftf: 'None' },
  { name: 'Capital One VentureOne', fee: '$0', bonus: '20k miles ($500/3mo)', perk: '1.25x all, 5x (C1 Travel)', apr: '0% intro 15mo, then 19.24%-29.24% Var.', ftf: 'None' },
  { name: 'Wells Fargo Autograph℠', fee: '$0', bonus: '20k pts ($1k/3mo)', perk: '3x travel, dining, gas, transit, streaming, phone', apr: '0% intro 12mo, then 19.24%-29.24% Var.', ftf: 'None' },
  { name: 'Bilt Mastercard®', fee: '$0', bonus: '1x rent (5 txn/mo req.)', perk: '3x dining, 2x travel, 1:1 transfers', apr: '20.49%-28.49% Var.', ftf: 'None' },
  { name: 'Discover it® Miles', fee: '$0', bonus: 'Miles Match (Yr1)', perk: '1.5x all (3x Yr1 eff.)', apr: '0% intro 15mo, then 18.24%-27.24% Var.', ftf: 'None' },
  { name: 'Chase Freedom Unlimited®', fee: '$0', bonus: 'Extra 1.5% up to $20k spend (Yr1) (verify)', perk: '5x travel (Chase), 3x dining/drugstores, 1.5x all', apr: '0% intro 15mo, then 18.99%-28.49% Var.', ftf: '3%' },
  { name: 'Bank of America® Travel Rewards', fee: '$0', bonus: '25k pts ($1k/90d)', perk: '1.5x all (up to 2.62x w/ Preferred Rewards)', apr: '0% intro 15 cycles, then 18.24%-28.24% Var.', ftf: 'None' },
];
...
const faqData = [
    {
        ...
        answer: "Most starter travel credit cards require a good to excellent credit score, generally a FICO score of 670 or higher. Some cards may be accessible with a slightly lower score, but a good score significantly improves your approval odds and the quality of cards you can get."
    },
    {
    ...
    {
        question: "What’s more important: a low annual fee or high rewards?",
...
function generateJsonLD() {
  const itemListElements = starterCardData.map((card, i) => ({
    ...
    item: {
      ...
      description: card.whyGreat, // Using 'whyGreat' as a product description
      brand: {
        '@type': 'Brand',
        name:
      ...
      // To add issuer (manufacturer), you might need a more specific field in cardData
      // Example: manufacturer: { '@type': 'Organization', name: card.issuerName }
      offers: {
        '@type': 'Offer',
        priceCurrency: 'USD',
        price: card.annualFee.replace('$', '').replace('Free', '0').replace('*', ''), // Assuming 'Free' or '$0' for no fee
      },
      aggregateRating: {
        '@type': 'AggregateRating',
        ratingValue: card.ratingValue,
        bestRating: '10',
        reviewCount: 1, // This implies "Our Rating" or a single review source
      },
    },
  }));
  ...
  const articleSchema = {
    ...
    headline: 'Best Starter Travel Credit Cards for 2025', // Matching H1
    description: 'Your guide to the top beginner travel rewards cards in the US for 2025. Find cards with low fees, simple rewards, and great perks to start your travel journey.', // Matching meta description
    image: [`${SITE_BASE_URL}${HERO_IMAGE_SRC}`],
    author: {
      '@type': 'Person',
      name: author.name,
      url: author.social.linkedin || SITE_BASE_URL, // Link to author page or LinkedIn
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: `${SITE_BASE_URL}/images/logo-120.png`, // ✏️ Ensure this logo exists
      },
    },
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="Top Starter Travel Credit Cards for 2025: Begin Your Journey" />
        ...
        {/* ✏️ Add preloads for critical fonts if not already globally handled */}
      ...
      <main className={styles.reviewContainer}>
                         ...
                         {author.social && ( 
                              <div className={styles.authorTooltipSocials}>
                                  {Object.entries(author.social).map(([platform, link]) => link && (
                                    <a key={platform} href={link} target="_blank" rel="noopener noreferrer" aria-label={`${author.name} on ${platform.charAt(0).toUpperCase() + platform.slice(1)}`} className={styles.socialIconLink}>
                                      {/* Basic SVGs - replace with your preferred icons */}
        ...
        <p className={styles.disclaimer}>
          Disclaimer: Information, including APRs and bonus offers, is based on sources available up to May 2025 and is subject to change. Verify all details directly with the card issuer before applying. This page may contain affiliate links.
        </p>
        ...
        <article>
          ...
          <section className={styles.reviewSection}>
            ...
            <p>Despite this, now is a fantastic time to start. A beginner-friendly card helps build a positive credit history—essential for bigger financial goals. {/* Example external link: <a href="https://www.consumerfinance.gov/consumer-tools/credit-reports-and-scores/" target="_blank" rel="noopener noreferrer">Learn more about building credit</a>. */} Starter cards are designed for simplicity, offering an easier introduction to earning and redeeming rewards responsibly.</p>
          </section>
            ...
            {starterCardData.map((card, index) => (
              <div key={card.id} className={`${styles.cardDetailSection} ${styles.cardSeparator}`}>
                ...
                <ul>
                  ...
                  <li><strong>APR:</strong> {card.apr} (Always check current rates & fees with the issuer)</li>
                ...
                <div className={styles.cardButtonsContainer}>
                    <a
                      href={card.applyLink} // ✏️ Replace with actual link
                      target="_blank"
                    ...
                    >
                     ...
                     <a
                      href={card.ratesFeesLink} // ✏️ Replace with actual link
                      target="_blank"
                      rel="noopener noreferrer sponsored" 
              ...
              <table className={styles.comparisonTable}>
                ...
                <tbody>
                    ...
                    <tr key={row.name}>
                        ...
                        <td>{row.bonus}</td>
                        <td>{row.perk}</td>
                        <td>{row.apr.includes("intro") ? row.apr.split("then ")[1] || row.apr : row.apr}</td>
                        <td>{row.ftf}</td>
                    </tr>
                    ))}
                </tbody>

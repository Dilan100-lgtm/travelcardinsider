...
import React, { useState, useRef, useEffect, useCallback } from 'react'; // Added useEffect, useCallback
import Head from 'next/head';
import Image from 'next/image';
import Link from 'next/link'; // Added for author bio link
...
const reviewDataNew = {
  ...
  author: { 
      ...
      socialLinks: {
          linkedin: 'https://www.linkedin.com/in/dilan-madushanka-b65293365', // Corrected to full URL
  ...
  imageUrl: "/darrin-henein-sREvt-W52Tc-unsplash.webp", // IMPORTANT: Update this path if it's different for the main card image
...
// This is the main React component for your page
export default function AlaskaAirlinesVisaSignatureReview2025() {
  // Hooks and handlers for Author Bio Tooltip moved inside the component
  ...
  // Main JSX return for the component
  return (
    <>
      <Head>
      ...
      <main style={{ fontFamily: 'Arial, sans-serif' }}> 
        <article className={styles.reviewContainer}>
          <header className={styles.reviewHeader}>
            ...
            {/* Author Bio Section with Tooltip */}
            <div
            ...
            >
                ...
                {showAuthorBioTooltip && (
                    <div // This was: className={styles.authorBioContainer} which seems like a duplication of the trigger's class
                        className={styles.authorTooltip} // Changed to specific tooltip class
                        ref={authorTooltipRef}
                        role="tooltip"
                        onMouseEnter={handleTooltipMouseEnter} 
                        onMouseLeave={handleAuthorMouseLeave}
                        onFocus={handleTooltipMouseEnter} // Keep open if focus moves into tooltip
            ...
            {/* Main Card Image - was duplicated, removed one instance. This is for the header. */}
            <div style={{ marginTop: '1rem', marginBottom: '1rem' }}>
              <Image
                src={reviewDataNew.imageUrl}
                alt={`${reviewDataNew.cardName} from ${reviewDataNew.issuerName}`}
                width={reviewDataNew.imageWidth} // Using main image dimensions from reviewDataNew
                height={reviewDataNew.imageHeight} // Using main image dimensions from reviewDataNew
      ...
      <div className={styles.stickyCtaContainer}>
        ...
        <a
          href={reviewDataNew.learnMoreLink} 

...
// --- Corrected Imports ---
import React, { useState, useEffect, useCallback, useRef } from 'react'; // Added missing hooks
...
// --- Schema Imports (Assuming these paths are correct) ---
...
import schemaCard1 from '@/schemas/zeroapr/chase-freedom-unlimited.json';
import schemaCard2 from '@/schemas/zeroapr/us-bank-altitude-connect.json';
import schemaCard3 from '@/schemas/zeroapr/citi-custom-cash.json';
import schemaCard4 from '@/schemas/zeroapr/bofa-travel-rewards.json';
import schemaCard5 from '@/schemas/zeroapr/discover-it-miles.json';
import schemaCard6 from '@/schemas/zeroapr/wells-fargo-active-cash.json';
import schemaCard7 from '@/schemas/zeroapr/blue-cash-everyday.json';
import schemaCard8 from '@/schemas/zeroapr/citi-diamond-preferred.json';
import schemaCard9 from '@/schemas/zeroapr/wells-fargo-reflect.json';
import schemaCard10 from '@/schemas/zeroapr/us-bank-cash-plus.json';
...
const cardsData = [
    // Example entry structure (PASTE ALL 10 CARD OBJECTS HERE):
    {
        ...
        tciRating: '8.1', // Rating from detailed card section
        applyUrl: 'https://creditcards.chase.com/cash-back-credit-cards/freedom/unlimited', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/chase-freedom-unlimited', // *** REPLACE with actual internal link ***
    ...
    },
    {
        ...
        applyUrl: 'https://www.citi.com/credit-cards/citi-custom-cash-credit-card', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/citi-custom-cash', // *** REPLACE with actual internal link ***
        ...
        imageUrl: '/download.png', // Assuming this is the correct image for Citi Custom Cash
    ...
    },
    {
        ...
        applyUrl: 'https://www.bankofamerica.com/credit-cards/products/travel-rewards-credit-card/', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/boa-travel-rewards', // *** REPLACE with actual internal link ***
    ...
    },
    {
        ...
        applyUrl: 'https://www.discover.com/credit-cards/travel/', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/discover-it-miles', // *** REPLACE with actual internal link ***
    ...
    },
     {
        ...
        applyUrl: 'https://creditcards.wellsfargo.com/active-cash-credit-card/?SGNTST=SGNCTL1&sub_channel=SEO&vendor_code=G', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/wells-fargo-active-cash', // *** REPLACE with actual internal link ***
    ...
    },
    {
        ...
        applyUrl: 'https://www.americanexpress.com/us/credit-cards/card/blue-cash-everyday/', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/blue-cash-everyday', // *** REPLACE with actual internal link ***
    ...
    },
    {
        ...
        applyUrl: 'https://www.citi.com/credit-cards/citi-diamond-preferred-credit-card', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/citi-diamond-preferred', // *** REPLACE with actual internal link ***
        ...
        imageUrl: '/download (1).png', // Assuming this is the correct image
    ...
    },
    {
        ...
        applyUrl: 'https://creditcards.wellsfargo.com/reflect-visa-credit-card/?SGNTST=SGNCTL1&sub_channel=SEO&vendor_code=G', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/wells-fargo-reflect', // *** REPLACE with actual internal link ***
    ...
    },
     {
        ...
        tciRating: '7.4', // Rating from detailed card section
        applyUrl: 'https://www.usbank.com/credit-cards/cash-plus-visa-signature-credit-card.html', // *** REPLACE with ACTUAL affiliate link ***
        learnMoreUrl: '/cards/us-bank-cash-plus', // *** REPLACE with actual internal link ***
...
const schemaData = {
    ...
    "@graph": [
        ...
        { // Define the CollectionPage specifically
            ...
            "@id": pageUrl,
            "url": pageUrl,
            "name": "Best 0% APR & Balance Transfer Credit Cards 2025 | TravelCardInsider",
            "headline": "Best 0% APR & Balance Transfer Savings in 2025",
            ...
            "mainEntity": {
                ...
                "itemListElement": cardsData.map((card, index) => ({ // Map cardData to create ListItems referencing imported product schemas
                        "@type": "ListItem",
                        "position": index + 1,
                        "item": { "@id": card.schema['@id'] || `#${card.id}` } // Link ListItem to the @id within the imported schema
                    }))
            }
        },
    ...
    return (
        <>
            ...
            <Head>
                 ...
                 {/* Use next/font if configured in _app.js, otherwise keep font links */}
                 {/* Preload critical fonts */}
        <link rel="preload" href="/fonts/Roboto_Condensed-Regular.ttf" as="font" type="font/ttf" crossOrigin="anonymous" />
        <link rel="preload" href="/fonts/Roboto_Condensed-Bold.ttf" as="font" type="font/ttf" crossOrigin="anonymous" />
        <link rel="preload" href="/fonts/PlayfairDisplay-Regular.ttf" as="font" type="font/ttf" crossOrigin="anonymous" />
        <link rel="preload" href="/fonts/Playfair-Display-Bold.ttf" as="font" type="font/ttf" crossOrigin="anonymous" />
{/* Render the combined schema */}
...
<link rel="alternate" href="https://www.travelcardinsider.com" hreflang="en-us" />
            ...
            <main className={styles.pageWrapper}>
                ...
                <section className={styles.hero}>
                     <Image alt="Image" src="/AdobeStock_446734479.webp" layout="fill" objectFit="cover" objectPosition="top center" quality={80} priority className={styles.heroBackgroundImage} />

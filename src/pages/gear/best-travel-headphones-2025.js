...
const HERO_IMAGE_SRC = '/headphones-hero-2025.jpg'; // ❗ Replace with your optimised hero image
...
const headphoneData = [
    {
        ...
        images: [
            { src: '/sony-wh1000xm6-front.jpg', alt: 'Sony WH-1000XM6 front view' },
            { src: '/sony-wh1000xm6-folded.jpg', alt: 'Sony WH-1000XM6 folded in its case' },
            { src: '/sony-wh1000xm6-lifestyle.jpg', alt: 'Sony WH-1000XM6 in a travel setting' },
        ],
    ...
    },
    {
        ...
        images: [
            { src: '/bose-qc-ultra-front.jpg', alt: 'Bose QuietComfort Ultra front view' },
            { src: '/bose-qc-ultra-comfort.jpg', alt: 'Bose QuietComfort Ultra showing plush earcups' },
            { src: '/bose-qc-ultra-lifestyle.jpg', alt: 'Bose QuietComfort Ultra used on a plane' },
        ],
    ...
    },
    {
        ...
        images: [
            { src: '/sennheiser-momentum4-front.jpg', alt: 'Sennheiser Momentum 4 front view' },
            { src: '/sennheiser-momentum4-battery.jpg', alt: 'Sennheiser Momentum 4 showing its long battery life concept' },
            { src: '/sennheiser-momentum4-lifestyle.jpg', alt: 'Sennheiser Momentum 4 on a long journey' },
        ],
